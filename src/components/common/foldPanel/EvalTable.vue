<template>
  <div class="eval-text">
    <div class="word" v-if="type == 1">
      <el-table :data="list" height="213px">
        <!-- 列表主要数据 -->
        <el-table-column
...
<script>
import VueAudio from "views/teacher/ManageStudentCourseDetail/VueAudio";
export default {
  components: { VueAudio },
  data() {
    return {
      ...
      headerList1: [
        ...
        { name: "音标得分", prop: "phoneticScoreList", width: "210px" },
        { name: "得分", prop: "score" },
        { name: "回放", prop: "audio" },
      ],
      headerList11: [
        { name: "单词文本", prop: "evalText" },
        { name: "音标得分", prop: "phoneticScoreList", width: "210px" },
        { name: "得分", prop: "score" },
        { name: "回放", prop: "audio" },
      ],
      headerList12: [
        { name: "句子文本", prop: "evalText" },
...
.eval-text {
  ...
  .el-table__header-wrapper{
    ...
    // [背景颜色] 表格鼠标悬停的样式
    tbody tr:hover > td {
      background-color: rgba(248, 181, 81, 0.1) !important;
    }
  }
  .overflow {
    //超出宽度，打点显示
