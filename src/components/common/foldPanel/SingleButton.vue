    ...
    <div class="button-panel">
      <div class="button-wrapper">
        <div class="button-list" :class="[isShow?'button-list-open':'button-list-close']">
          <button
            id="button"
            :class="[type==1?'word-btn':'long-btn']"
            class="btn"
        ...
        <div class="list-open" v-show="unfold" @click="closeList">
          {{ isShow?'收缩':'展开' }}
  ...
  methods: {
    ...
    btnStyle(index) {
      if (index == this.cIndex) {
        ...
        return `color:${this.color}; border-color:${this.color};background-color:${this.backColor}`;
      }
    },
  },
};
