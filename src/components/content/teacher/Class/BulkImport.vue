      ...
      <div class="dialog-body">
        ...
        <div class="body-border">
           ...
           <div class="second-step">
            <div class="item-left-one"><span style="color:#F64656">*</span>选择文件：</div>
           <div class="img-da">
            <img  src="../../../../assets/img/admin/Shape.png" v-show="this.filename=='仅支持扩展名为zip的文件'">
           </div>
           <div :class="img">{{filename}}</div>
           <div class="img-delete" v-if="this.filename!='仅支持扩展名为zip的文件'"><img src="../../../../assets/img/admin/cancel-file.png" @click="cancle()"></div>
           </div>
    ...
    getTeacherPSD() {
      this.$newApi.excel.getExcelUrl("teacher").then((res) => {
        ...
        if (res.code == 0) {
          ...
          this.$message.error("教师导入模板获取异常", result.message);
        }
      });
    },
 btnCancel() {
