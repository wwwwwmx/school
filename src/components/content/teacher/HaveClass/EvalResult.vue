    ...
    >
      <div class="f-body">
        ...
        <div class="body-content">
          <!-- 题目 -->
          <div class="content-item-top" ref="calcContent">
            <!-- 提交率和重读率弃用 -->
          ...
          <!-- 评测明细 -->
          <div
            class="content-item content-item-list"
          ...
          >
            ...
            >
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  <div v-if="scope.row.phoneticScoreList != null" class="todo">
                    <span class="todo-item text" @click="openDetail(scope.row)"
                      >详情</span
                    >
                    <span>|</span>
                    ...
                    <audio-dynamic
                      ...
                      Acolor="#FF7F00"
                    ></audio-dynamic>
                    <!-- <div class="todo-item" @click="downAudio(scope.row)">下载</div> -->
                  </div>
          ...
          >
            <el-table :data="rereadList" height="540px">
              <!-- 列表主要数据 -->
              <el-table-column
                v-for="(item, index) in headerList"
                :key="index"
