    ...
    <div class="situation-wrapper">
      ...
      <div class="situation-l">
        ...
        <div class="l-classroom-main">
          <FCircle class="classroom-circle" :n="info.participateRate" :r="60" />
          <div class="classroom-content">
            <div class="content-item">课堂人数：{{ info.classroomNum }}人</div>
            <div class="content-item">
              未参评人数：{{ info.noParticipateNum }}人
            </div>
            <div v-if="info.noParticipateList.length">
      ...
      <div class="situation-r">
        ...
        <div class="r-score-distribute">
          <div
            class="r-item"
            v-for="(item, index) in info.creditsList"
            :key="index"
          >
...
import FCircle from "cpns/content/teacher/eval-result/FCircle";

export default {
  name: "RightClassroomSituation",
  ...
  data() {
    return {
      imgList: [
        ...
        require("assets/img/eval-result/credits/4.png"),
        require("assets/img/eval-result/credits/5.png"),
      ],
    };
  },
